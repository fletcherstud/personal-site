...
const Contact = () => {
  ...
  return (
    <section id="contact" className="py-24 bg-slate-800/50 backdrop-blur-sm">
            ...
            <div className="space-y-8">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <a href="mailto:john.fletcher@example.com" className="text-slate-300 hover:text-blue-400 transition-colors duration-300">
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <a href="tel:+1234567890" className="text-slate-300 hover:text-indigo-400 transition-colors duration-300">
                    +1 (234) 567-890
                  </a>
                </div>
              </div>
